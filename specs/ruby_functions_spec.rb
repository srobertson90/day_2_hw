...
class Functions_Practice < MiniTest::Test
  ...
  def test_volume_of_sphere()
    ...
    assert_equal(33.51, sphere_result)
  end

  #You can add your own converters
  def test_fahrenheit_to_celsius()
    temperature_result = fahrenheit_to_celsius(68)
    assert_equal(20, temperature_result)
  end

  def test_airspeed_velocity_of_an_unladen_swallow()
    answer = airspeed_velocity_of_an_unladen_swallow("Huh? I... I don't know that.")
    assert_equal("*thrown off bridge*", answer)
  end
